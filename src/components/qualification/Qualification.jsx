...
const Qualification = () => {
  ...
  return (
    <section className="qualification section">
        <h2 className="section__title quali">Qualification</h2>
            ...
            <div className="qualification__sections">
                ...
                "qualification__content "}>
                    <div className="qualification__data">
                        <div>
                        <h3 className="qualification__title">IT Engineering</h3>
                        <span className="qualification__subtitle">Pune - Institute</span>
                    ...
                    <div className="qualification__data">
                        ...
                        <span className="qualification__subtitle">MSBSHSE</span>
                        <div className="qualification__calender">
                    ...
                    {/* <div className="qualification__data">
                        ...
                        <span className="qualification__subtitle">MSBSHSE</span>
                        <div className="qualification__calender">
                            <i class="uil uil-calender-alt"></i>2018
                        </div>
                        </div>
                    </div> */}
                </div>
                ...
                "qualification__content "}>
                    <div className="qualification__data">
                        <div>
                        <h3 className="qualification__title">SmartInterz</h3>
                        <span className="qualification__subtitle">App Development</span>
                        <div className="qualification__calender">
                        <i class="uil uil-calendar-alt"></i>Aug-Sep 2022
                        </div>
                        </div>
                        <div>
                            <span className="qualification__rounder"></span>
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                        <h3 className="qualification__title">Future Ready Talent</h3>
                        <span className="qualification__subtitle">Web Developer</span>
                        <div className="qualification__calender">
                        <i class="uil uil-calendar-alt"></i>July–Aug 2022
                        </div>
                        </div>
                    </div>
                    ...
                    <div className="qualification__data">
                        <div>
                        <h3 className="qualification__title">InterPe</h3>
                        <span className="qualification__subtitle">Web Designer</span>
                        <div className="qualification__calender">
                        <i class="uil uil-calendar-alt"></i>june-july 2023
                        </div>
                        </div>
                        <div>
                            <span className="qualification__rounder"></span>
