...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Aryan Gaikwad
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I'm a Frontend Developer, always passionate to work on different Web Dev projects.</p>
